			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="course_container">
						<div class="course_title">Paket Sekolah Dasar</div>
						<div class="course_info d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
							...
							<div class="course_info_item">
								...
								<div class="course_info_text"><a href="#">Sekolah Dasar</a></div>
							</div>

						</div>

						<!-- Course Image -->
						<div class="course_image"><img src="images/course_1.png" style="width: 650px" alt=""></div>
						...
						<div class="course_tabs_container">
							...
							<div class="tab_panels">
								...
								<div class="tab_panel active">
									<div class="tab_panel_title">Paket Sekolah Dasar</div>
					...
					<div class="sidebar">
						...
						<div class="sidebar_section">
							...
							<div class="sidebar_feature">
								<div class="course_price">Rp <?=$sd1?>,-</div>
