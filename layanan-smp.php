			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="course_container">
						<div class="course_title">Paket Sekolah Menengah Pertama</div>
						<div class="course_info d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
							...
							<div class="course_info_item">
								...
								<div class="course_info_text"><a href="#">Sekolah Menengah Pertama</a></div>
							</div>

						</div>

						<!-- Course Image -->
						<div class="course_image"><img src="images/course_2.jpeg" alt=""></div>
						...
						<div class="course_tabs_container">
							...
							<div class="tab_panels">
								...
								<div class="tab_panel active">
									<div class="tab_panel_title">Paket Sekolah Menengah Pertama</div>
									<div class="tab_panel_content">
										<div class="tab_panel_subtitle">A.Ketentuan dan Syarat</div>
										<ul class="tab_panel_bullets">

											<li>Untuk setiap tingkat(SD,SMP,dan SMA) privat berisi 8 kali pertemuan masing masing pertemuan lamanya 90 menit</li>
											<li>Setiap siswa bebas memilih mata pelajaran yang akan diikuti sesuai dengan yang ditawarkan oleh "Kalam Pena Private Centre".</li>
											<li>Setiap mata pelajaran akan dibimbing oleh 1 orang guru kecuali tingkat SD semua mata pelajaran yang ditawarkan hanya dibimbing 1 orang guru pembimbing</li>
											<li>Siswa dibimbing sesuai dengan bidang studi dan kurikulum yang digunakan di sekolah</li>
											
										</ul>
										<div class="tab_panel_section">
											<div class="tab_panel_subtitle">B.Mata Pelajaran</div>
											<ul class="tab_panel_bullets">
												<li>Matematika.</li>
												<li>IPA.</li>
										...
										<div class="tab_panel_section">
											<div class="tab_panel_subtitle">C.Biaya dan Sistem Pembayaran</div>
											<ul class="tab_panel_bullets">
												<div class="tab_panel_subtitle">Biaya</div>
												<font color="black">
												<table border="1" width="100%">
												<tr>
													<td rowspan="2">1 Paket(8 x 90 menit)</td>
												...
												$sd2 = stripslashes($hargaSD['harga2']);
												$sd3 = stripslashes($hargaSD['harga3']);
												...
												$smp2 = stripslashes($hargaSMP['harga2']);
												$smp3 = stripslashes($hargaSMP['harga3']);
												...
												$sma2 = stripslashes($hargaSMA['harga2']);
												$sma3 = stripslashes($hargaSMA['harga3']);
											...
											<div class="tab_panel_subtitle">Sistem Pembayaran</div>
												<li>Biaya belajar dibayar diawal kegiatan belajar dan bisa diangsur dua kali pembayaran dengan angsuran pertama 50% dari jumlah biaya keseluruhan</li>
												<li>Membayar uang pendaftaran sebesar Rp 300.000,-</li>
												<li>Pembayaran dilakukan dengan melalui transfer ke:</br>
												Rek. Mandiri : 164 00 02534 594 a.n. Firdausi</br>
												Rek. Muamalat : 388 000 7743 a.n. Firdausi</br></li>
												</li>
											</div>

										<!-- <div class="tab_panel_section">
											<div class="tab_panel_subtitle">C.Target Pembelajaran</div>
				...
				<div class="col-lg-4">
					<div class="sidebar">
						...
						<div class="sidebar_section">
							<div class="sidebar_section_title">Layanan Bimbel</div>
							<div class="sidebar_feature">
								<div class="course_price">Rp <?=$smp1?>,-</div>
								...
								<div class="feature_list">
									...
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										...
										<div class="feature_text ml-auto">90 minutes/day</div>
									</div>

									<!-- Feature -->
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-file-text-o" aria-hidden="true"></i><span>Kurikulum:</span></div>
										<div class="feature_text ml-auto">8</div>
									</div>

									<!-- Feature -->
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-question-circle-o" aria-hidden="true"></i><span>Konsultasi:</span></div>
										<div class="feature_text ml-auto">Free</div>
									</div>

									<!-- Feature -->
									<div class="feature d-flex flex-row align-items-center justify-content-start">
										<div class="feature_title"><i class="fa fa-list-alt" aria-hidden="true"></i><span>Ketersediaan:</span></div>
										<div class="feature_text ml-auto">Tersedia</div>
									</div>
